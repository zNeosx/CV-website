      ...
      <section id="page">
        <div className="about">
          ...
          <div className="info">
            ...
            <h3>
              <span>Spécialisation : </span> React Js, React Native et Node.js
            </h3>
            <a
              href={process.env.PUBLIC_URL + `documents/CV-Vincent-AIPAR.pdf`}
              target="_blank"
              className="cv__link"
            >
              Téléchargez mon CV
          ...
          <div className="box">
            <div className="box-item">
              <div className="box-item-inner">
                ...
                <span>2017 - 2020</span>
                <h3>
                  Licence EEA : Electronique Energie electrique Automatique{" "}
                </h3>
